...
const review = [
  ...
  },
  {
    ...
    rating: 5,
    review: " If you're on the hunt for an exceptional espresso experience, look no further than this local 5-star coffee shop. Their espresso blew me away with its robust and complex flavors. The aroma alone was enough to captivate my senses, and the taste was nothing short of phenomenal. The crema on top was velvety and luscious, a true sign of a well-crafted espresso. The beans used were clearly of the highest quality, and the attention to detail in the preparation was evident. The staff were friendly, knowledgeable, and passionate about their craft. Treat yourself to a cup of their espresso, and you'll understand why this place is deserving of its 5-star rating. Absolutely outstanding!"
  },
  {
    coffeeId: 2,
    userId: 2,
  ...
  },
  {
    ...
    rating: 5,
    review: "I recently discovered this hidden gem of a coffee shop, and I can't get enough of it! The moment I stepped inside, I was greeted by the inviting aroma of freshly brewed coffee. The ambiance is cozy and warm, with comfortable seating and soft lighting. The baristas are incredibly knowledgeable and passionate about their craft, always eager to recommend a new blend or brewing method. I have tried several drinks from their extensive menu, and each one has been a delightful experience. Whether it's a classic cappuccino or a unique seasonal specialty, the coffee is consistently exceptional. The staff's attention to detail and dedication to quality is truly commendable. This local coffee shop has quickly become my go-to place for a perfect cup of joe. I highly recommend it to all coffee lovers!"
  },
  {
    coffeeId: 3,
    userId: 3,
  ...
  },
  {
    ...
    rating: 5,
    review: "The coffee was brewed to perfection, with a velvety texture and a balanced combination of boldness and smoothness. The attention to detail in the preparation was evident, and the staff's knowledge and passion for their craft were truly admirable. The cozy ambiance of the shop, along with the genuine friendliness of the staff, added to the overall delightful experience."
  },
  {
    coffeeId: 9,
    userId: 3,
  ...
  },
  {
    ...
    rating: 5,
    review: "I highly recommend this place for anyone looking to savor a fantastic Irish Coffee that hits all the right notes!"
  },
  {
    coffeeId: 10,
    userId: 3,
